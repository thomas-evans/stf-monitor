...
xdescribe('DataSetSelectorComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    const mnemonicsSpy = jasmine.createSpyObj(MnemonicsService, ['getMnemonics']);
    TestBed.configureTestingModule({
      declarations: [DataSetSelectorComponent],
      imports: [IonicModule.forRoot()],
      providers: [{provide: MnemonicsService, useValue: mnemonicsSpy}]
    }).compileComponents();
    mnemonicsService = TestBed.inject(MnemonicsService) as jasmine.SpyObj<MnemonicsService>;
